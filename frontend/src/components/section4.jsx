  ...
  return (
    <>
      <section className="bg-[#191919] font-Poppins py-12 md:py-0">
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center gap-10 px-5 md:px-0  md:ps-5">
          <div className="lg:flex-grow md:w-1/2 flex flex-col md:items-start items-center text-center md:text-left md:ps-10 lg:ps-36">
            ...
            <p className="text-white text-pretty text-2xl sm:text-3xl font-normal mb-6 sm:mb-10 leading-relaxed max-w-md">
              Accelerate into a New Era
            </p>
            <p className="text-white text-pretty text-sm font-light mb-4 sm:mb-6 leading-relaxed max-w-md">
